        ...
        <footer className="bg-neutral-900 text-white pt-20 pb-10" role="contentinfo" aria-label="Site alt bilgi">
            ...
            <div className="container-custom grid lg:grid-cols-4 gap-12 mb-16">
                ...
                <div className="lg:col-span-1">
                    ...
                    <p className="text-neutral-400 text-sm leading-relaxed mb-6">
                        Beylikdüzü ve Gürpınar bölgesinde {businessConfig.brand} yetkili bayisi olarak hizmet vermekteyiz. Isı yalıtımı ve güvenlikte dünya standartlarını evinize getiriyoruz.
                    </p>
            ...
            <div className="container-custom mb-8">
                <p className="text-xs text-neutral-600 text-center max-w-4xl mx-auto leading-relaxed">
                    ...
                    İstanbul Avrupa yakasında Egepen Deceuninck yetkili bayisi. Profesyonel hizmet ve ücretsiz keşif.
                </p>
            </div>
