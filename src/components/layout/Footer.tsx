            ...
            <div className="container-custom mb-16">
                <div className="bg-neutral-800/50 rounded-2xl p-8">
                    <h2 className="text-2xl font-bold text-white mb-6 text-center">
                        <span aria-hidden="true">🏠</span> Hizmet Bölgelerimiz
                    </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8" role="list" aria-label="Hizmet verilen bölgeler">
                        {/* Beylikdüzü Neighborhoods */}
                        <div>
                            <h3 className="text-lg font-bold text-primary-400 mb-4 flex items-center gap-2">
                                <span className="w-8 h-8 bg-primary-500/20 rounded-lg flex items-center justify-center" aria-hidden="true">📍</span>
                                Beylikdüzü
                            </h3>
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-secondary-400 mb-4 flex items-center gap-2">
                                <span className="w-8 h-8 bg-secondary-500/20 rounded-lg flex items-center justify-center" aria-hidden="true">📍</span>
                                Büyükçekmece
                            </h3>
                            <div className="grid grid-cols-2 gap-1">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-accent-400 mb-4 flex items-center gap-2">
                                <span className="w-8 h-8 bg-accent-500/20 rounded-lg flex items-center justify-center" aria-hidden="true">🗺️</span>
                                Yakın İlçeler
                            </h3>
                            <div className="grid grid-cols-2 gap-1">
                ...
                <div className="lg:col-span-1">
                    ...
                    <div className="flex gap-4">
                        <a href={businessConfig.social.facebook} target="_blank" rel="noopener noreferrer nofollow" title="Egepen Akçayapı Facebook Sayfası" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary-500 transition-colors" aria-label="Facebook">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z" /></svg>
                        </a>
                        ...
                        <a href={businessConfig.social.twitter} target="_blank" rel="noopener noreferrer nofollow" title="Egepen Akçayapı Twitter/X" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary-500 transition-colors" aria-label="Twitter">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.045 4.126H5.078z" /></svg>
                        </a>
                    </div>
                </div>
