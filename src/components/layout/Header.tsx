...
const navigationItems = [
    {
        ...
        children: [
            ...
            { label: "Evolution Serisi", href: "/pvc-sistemleri/evolution-pvc-pencere" },
    ...
    },
    {
        ...
        children: [
            { label: "Motorlu Panjur", href: "/panjur-kepenk-sistemleri/motorlu-panjur-premium" },
            { label: "Manuel Panjur", href: "/panjur-kepenk-sistemleri/manuel-panjur-ekonomik" },
            { label: "Işık Kontrollü Panjur", href: "/panjur-kepenk-sistemleri/isik-kontrollu-panjur" },
            { label: "Endüstriyel Kepenk", href: "/panjur-kepenk-sistemleri/endustriyel-kepenk" },
            { label: "Alüminyum Kepenk", href: "/panjur-kepenk-sistemleri/aluminyum-kepenk" },
            { label: "Garaj Kapısı", href: "/panjur-kepenk-sistemleri/garaj-kapisi-seksiyonel" },
        ],
    },
    {
        label: "Duşakabin",
        ...
        children: [
            { label: "Çerçevesiz Pivot", href: "/dusakabin-sistemleri/frameless-pivot" },
            { label: "Çerçevesiz Sürme", href: "/dusakabin-sistemleri/frameless-sliding" },
            { label: "Walk-in Sistem", href: "/dusakabin-sistemleri/walk-in-single" },
            { label: "Küvet Üstü Cam", href: "/dusakabin-sistemleri/bathtub-pivot" },
            { label: "Yarı Çerçeveli", href: "/dusakabin-sistemleri/semi-frameless" },
        ],
    },
    {
        label: "Bilgi",
