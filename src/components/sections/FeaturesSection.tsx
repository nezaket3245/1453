...
import { motion, useInView } from "@/lib/motion-lite";
...
function FeatureCard({ feature }: { feature: (typeof features)[0] }) {
    ...
    return (
        <article className="group relative bg-white rounded-2xl p-6 lg:p-8 border border-neutral-100 shadow-sm hover:shadow-xl transition-[box-shadow,transform] duration-300 hover:-translate-y-1">
            {/* Icon */}
            <div
                className={cn(
...
function ThermometerIcon({ className }: { className?: string }) {
    return (
        <svg className={className} fill="none" viewBox="0 0 24 24" aria-hidden="true" stroke="currentColor" strokeWidth={1.5}>
