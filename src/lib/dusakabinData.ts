...
Dorma veya Bohle premium aksesuar seçenekleri ile soft-close kapanış, 180° açılım ve 10 yıla kadar dayanıklılık sunar. Kireç tutmayan Nano-Clear kaplama opsiyonu ile minimum bakım, maksimum hijyen.`,
        ...
        technicalSpecs: [
            ...
            { label: 'Dayanıklılık', value: '10 yıl', highlight: true },
        ],
        ...
        warranty: '10 yıl profil + 5 yıl cam',
...
Paslanmaz çelik rulman sistemi, on binlerce açılış-kapanış döngüsüne dayanıklıdır. Sessiz çalışma için özel tasarlanmış tekerlek sistemi, gece kullanımında bile rahatsızlık vermez.`,
        ...
        technicalSpecs: [
            ...
            { label: 'Dayanıklılık', value: '7 yıl', highlight: true },
        ],
    ...
    // ========== SLIDING & CORNER ENTRY ==========
    {
        ...
        description: 'Çift yönlü sürme kapılar ile merkezi giriş. Alman mühendisliği tekerlek sistemi, 100.000 döngü dayanıklılık.',
...
Alman Häfele tekerlek sistemi, sessiz ve akıcı hareket sağlar. Magnetic seal teknolojisi, %100 su sızdırmazlık sağlar.`,
        ...
        benefits: ['Ultra sessiz çalışma (<30dB)', '100.000 döngü mekanik dayanıklılık', 'Kolay temizlik için çıkarılabilir panel'],
        technicalSpecs: [
            { label: 'Cam Kalınlığı', value: '6mm - 10mm' },
            { label: 'Ray Sistemi', value: 'Çift ray (üst+alt)' },
            { label: 'Ses Seviyesi', value: '<30dB', highlight: true },
            { label: 'Dayanıklılık', value: '10 yıl mekanik', highlight: true },
        ],
        ...
        faq: [{ question: 'Tekerlek sistemi arızalanırsa ne olur?', answer: '10 yıl mekanik destek kapsamında ücretsiz değişim yapılır.' }],
    },
    {
        ...
        technicalSpecs: [
            ...
            { label: 'Dayanıklılık', value: '5 yıl', highlight: true },
        ],
...
export const authorityGuides = [
    ...
    },
    {
        ...
        sections: [
            { heading: 'Duş Teknesi Avantajları', content: 'Kolay montaj, su yalıtımı. Kiralık evlerde tercih edilir.' },
